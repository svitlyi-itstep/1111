...
class Paladin(Character):
    ...
    '''
        У класі Paladin змінити реалізацію методу attack таким чином, 
        щоб противники, в яких поле type дорівнює 'undead', отримували
        на 20% більше шкоди від атаки паладіна.
    '''